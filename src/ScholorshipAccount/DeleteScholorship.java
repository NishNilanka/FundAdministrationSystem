 ...
 * @author Thilina
 */
public class DeleteScholorship extends javax.swing.JFrame {

    /**
     * Creates new form DeleteScholorship
     */
    ScholorshipDetails em;
    public DeleteScholorship() {
        initComponents();
        
    }
  public void setFields(ScholorshipDetails std)
    {
        em = new ScholorshipDetails();
        ...
        em.setAccountNo(std.getAccountNo());
    ...
    private void initComponents() {
        ...
        setTitle("Delete Scholorship");
        setLocationByPlatform(true);
        setResizable(false);

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Delete Scholorship Details", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 14))); // NOI18N
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(btndeleteScholorship, javax.swing.GroupLayout.PREFERRED_SIZE, 137, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btndeleteScholorshipActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btndeleteScholorshipActionPerformed
        ...
        em.setScholorshipNo(Integer.parseInt(txtScholorshipNo.getText().toString()));
        em.setEmpFirstName(txtEmpFirsttName.getText());
        em.setLastName(txtEmpLastName.getText());
        em.setPrison(txtEmpPrison.getText());
        em.setNicNo(txtNICNo.getText());
        em.setFirstName(txtFirstName.getText());
        em.setEmpLastName(txtLastName.getText());
        em.setSchool(txtSchool.getText());
        em.setGender(txtGender.getText());
        em.setDob((txtDOB.getText()));
        em.setScholorshipType(txtScholorshipType.getText());
        em.setAmount(Float.parseFloat(txtAmount.getText().toString()));

        boolean result = db.deleteScholorship(em);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeleteScholorship.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeleteScholorship().setVisible(true);
            }
        });
    }
