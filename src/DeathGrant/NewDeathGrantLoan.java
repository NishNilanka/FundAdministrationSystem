 ...
 * @author Thilina
 */
public class NewDeathGrantLoan extends javax.swing.JFrame {

    DBoperations DBoperation = new DBoperations();
    DBoperationWithFinal DBWithFinal = new DBoperationWithFinal();

    /**
     * Creates new form NewDeathGrantLoan
     */
    public NewDeathGrantLoan() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnValidate3 = new javax.swing.JButton();
        ...
        setTitle("New death grant Loan");
        setLocationByPlatform(true);
        setResizable(false);

        jPanel8.setBorder(javax.swing.BorderFactory.createTitledBorder("New Death Grant Loan"));
        ...
        txtDeathGrantNo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtDeathGrantNotxtDeathGrantNoActionPerformed(evt);
            }
        });
        txtDeathGrantNo.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtDeathGrantNoKeyReleased(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txtDeathGrantNoKeyTyped(evt);
            }
        });

        btnValidate3.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        btnValidate3.setText("Validate");
        btnValidate3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnValidate3btnValidate1ActionPerformed(evt);
            }
        });
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(txtDeathGrantNo, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 217, Short.MAX_VALUE)
                            .addComponent(txtEmpNo, javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(txtDeathCertificateNo, javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(txtRelationship, javax.swing.GroupLayout.Alignment.TRAILING))
                        .addComponent(txtNICNo, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 217, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(txtEmpPrison, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 217, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(txtEmpLastName, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 217, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(txtEmpFirsttName, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 217, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(txtLastName, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 217, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(txtFirsttName, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 217, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
        ...
        txtLoanAmount.setText("12000.00");
    ...
    private void txtDeathGrantNotxtDeathGrantNoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtDeathGrantNotxtDeathGrantNoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtDeathGrantNotxtDeathGrantNoActionPerformed

    private void btnValidate3btnValidate1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnValidate3btnValidate1ActionPerformed

        if(txtDeathGrantNo.getText().equals("")){
            JOptionPane.showMessageDialog(this, "Please Enter a valid Death Grant No");
        }
        else{
     
            deathgrant = DBWithFinal.getMemberByDeathGrantNo(Integer.parseInt(txtDeathGrantNo.getText()));
            if (deathgrant == null) {
                JOptionPane.showMessageDialog(this, "Death Grant No is not valid");
        ...
        // TODO add your handling code here:
    }//GEN-LAST:event_btnValidate3btnValidate1ActionPerformed
    }
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        try {
            ...
            ed.setDeathGrantNo(Integer.parseInt(txtDeathGrantNo.getText()));
            ...
            boolean result = DBoperation.newDeathGrantLoan(ed);
            if (result) {
    ...
    private void txtDeathGrantNoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtDeathGrantNoKeyTyped
        // TODO add your handling code here:
          char c=evt.getKeyChar();
        String in =txtDeathGrantNo.getText();
    ...
    }//GEN-LAST:event_txtDeathGrantNoKeyTyped

    private void txtDeathGrantNoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtDeathGrantNoKeyReleased
        // TODO add your handling code here:
         if(!"".equals(txtDeathGrantNo.getText()))
        {
           btnValidate3.setEnabled(true);
        }
        else{
          
           btnValidate3.setEnabled(false);
        }
    }//GEN-LAST:event_txtDeathGrantNoKeyReleased
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewDeathGrantLoan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NewDeathGrantLoan().setVisible(true);
            }
        });
    }
    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton btnSubmit;
    private javax.swing.JButton btnValidate3;
