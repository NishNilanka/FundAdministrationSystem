 ...
 * @author Dell
 */
public class viewUpdatemem extends javax.swing.JFrame {

    /**
     * Creates new form viewUpdatemem
     */
    public viewUpdatemem() {
        initComponents();
    }
...
//        txtDOB.setText("");
    ...
    private void btnCloseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCloseActionPerformed
        ...
        try{
            ...
            boolean result = dbFinal.updateMember(md);
            ...
            if(result)
            {
                ...
                boolean r = db.deleteUpMember(md);
                this.dispose();
               // boolean re = dbFinal.deleteMemFi(md);
            }
            else
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(viewUpdatemem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new viewUpdatemem().setVisible(true);
            }
        });
    }
