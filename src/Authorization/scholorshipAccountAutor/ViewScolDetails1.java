 ...
 * @author Dell
 */
public class ViewScolDetails1 extends javax.swing.JFrame {

    /**
     * Creates new form ViewScolDetails1
     */
    public ViewScolDetails1() {
        initComponents();
    }
     ...
     public void setFields(ScholorshipDetails scol)
    {
        ...
        txtSavNo.setText(new Integer(scol.getAccountNo()).toString());
    ...
    private void btnCloseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCloseActionPerformed
        ...
        try{
            ...
            if(r)
            {
                ...
                clearFields();
                boolean re = dbFinal.deleteScolFi(sd);
            }
            else
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewScolDetails1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewScolDetails1().setVisible(true);
            }
        });
    }
