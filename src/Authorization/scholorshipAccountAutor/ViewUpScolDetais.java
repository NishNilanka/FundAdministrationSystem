 ...
 * @author Dell
 */
public class ViewUpScolDetais extends javax.swing.JFrame {

    /**
     * Creates new form ViewUpScolDetais
     */
    public ViewUpScolDetais() {
        initComponents();
    }
    ...
    private void btnCloseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCloseActionPerformed
        ...
        try{
            ...
            boolean result = dbFinal.updateScholorship(sd);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewUpScolDetais.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewUpScolDetais().setVisible(true);
            }
        });
    }
